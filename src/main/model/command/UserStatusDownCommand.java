...
/**
 * Command to decrease user status.
 */

public class UserStatusDownCommand implements ActionCommand {
    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        UserDAO userDAO = new UserDAO();
        userDAO.userStatusDown(new String(request.getParameter("login").getBytes("ISO-8859-1"), "UTF-8"));
